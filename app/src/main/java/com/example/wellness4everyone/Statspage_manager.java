...
public class Statspage_manager extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.manager_statspage);
    ...
    public void goback(View view){
        ...
        Intent intent = new Intent(Statspage_manager.this, UserActivities.class);
